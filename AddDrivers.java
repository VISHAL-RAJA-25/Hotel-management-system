...
public class AddDrivers extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		if (ae.getSource() == b1) {
			...
			// Validate fields
			if (name.isEmpty() || age.isEmpty() || company.isEmpty() || brand.isEmpty() || location.isEmpty() || gender == null) {
				JOptionPane.showMessageDialog(null, "Please fill all fields", "Error", JOptionPane.ERROR_MESSAGE);
				return;
			}

			conn c = new conn();
			String str = "INSERT INTO driver (name, age, gender, company, brand, availability, location) VALUES (?, ?, ?, ?, ?, ?, ?)";
			try {
