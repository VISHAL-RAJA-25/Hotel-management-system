...
public class AddEmployee extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (name.isEmpty() || age.isEmpty() || salary.isEmpty() || phone.isEmpty() || aadhar.isEmpty() || email.isEmpty() || job.equals("Select")) {
			JOptionPane.showMessageDialog(null, "Please fill all fields");
			return;
		}

		conn c = new conn();
		String str = "INSERT INTO employee (name, age, gender, job, salary, phone, aadhar, email) VALUES ('" + name + "','" + age + "','" + gender + "','" + job + "','" + salary + "','" + phone + "','" + aadhar + "','" + email + "')";
